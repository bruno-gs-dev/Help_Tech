...
<body class="bg-gradient-to-br from-blue-100 to-indigo-200 min-h-screen flex items-center justify-center">
  ...
  <div class="bg-white shadow-2xl rounded-3xl w-[90%] max-w-6xl p-0 overflow-hidden m-6">
    <!-- Cabeçalho -->
    <div class="bg-gradient-to-r from-blue-600 to-indigo-700 p-8 text-white flex items-center justify-between rounded-t-3xl">
    ...
    <div class="p-10 flex flex-col lg:flex-row gap-10">
      ...
      <div class="flex flex-col items-center w-full lg:w-1/3 bg-gray-50 rounded-2xl p-6 shadow-inner">
        ...
        <div class="mt-6 w-full space-y-3">
          ...
          <p class="text-gray-600"><span class="font-semibold">Nascimento:</span> <span id="display-birthdate">-</span></p>
        </div>
      </div>
  ...
  <script>
    ...
    function showNotification(message, type = 'success') {
      ...
      notification.className = `notification flex items-center gap-3 px-6 py-4 rounded-xl shadow-2xl max-w-md ${
        type === 'success' 
